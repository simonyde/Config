...
let
  ...
  gtk-package =
    if slug == "catppuccin-mocha" || slug == "catppuccin-latte" then
  ...
  gtk-theme =
    if slug == "catppuccin-mocha" then
      "Catppuccin-Mocha-Compact-Lavender-Dark"
    else if slug == "catppuccin-latte" then
      "Catppuccin-Latte-Compact-Lavender-Light"
    else
      slug;
