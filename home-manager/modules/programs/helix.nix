...
in
{
  programs.helix = {
    ...
    themes.base16 = with colors; {
      ...
      "variable" = "#${base05}";
      "variable.parameter" = { fg = "#${base09}"; modifiers = [ "italic" ]; };
      ...
      "tag" = "#${base0E}";
      "attribute" = "#${base0A}";
      "namespace" = { fg = "#${base0D}"; modifiers = [ "italic" ]; };
      ...
      "markup.heading.marker" = { fg = "#${base09}"; modifiers = [ "bold" ]; };
      "markup.italic" = { modifiers = [ "italic" ]; };
      "markup.link.text" = "#${base0D}";
      "markup.link.url" = { fg = "#${base06}"; modifiers = [ "underlined" ]; };
      "markup.list" = "#${base0E}";
      "markup.raw" = "#${base0F}";
      ...
      "ui.background" = { fg = "#${base05}"; bg = "none"; };
      "ui.linenr" = { fg = "#${base04}"; };
      ...
      "ui.highlight" = { bg = "#${base04}"; modifiers = [ "bold" ]; };

      "ui.menu" = { fg = "${overlay2}"; bg = "#${base02}"; };
      "ui.menu.selected" = { fg = "#${base05}"; bg = "#${base04}"; modifiers = [ "bold" ]; };
