  ...
  programs.yazi = {
    ...
    keymap = {
      manager.keymap = [
        ...
        # Navigation
        { on = [ "m" ]; exec = [ "leave" "escape --visual --select" ]; desc = "Go back to parent directory"; }
        ...
        { on = [ "<A-n>" ]; exec = "peek 5"; desc = "Peek down 5 units in the preview"; }
        { on = [ "<A-e>" ]; exec = "peek -5"; desc = "Peek up 5 units in the preview"; }
        ...
        { on = [ "U" ]; exec = "select_all --state=none"; desc = "Inverse selection of all files"; }
        ...
        # Linemode
        { on = [ "h" "s" ]; exec = "linemode size"; desc = "Set linemode to size"; }
        { on = [ "h" "p" ]; exec = "linemode permissions"; desc = "Set linemode to permissions"; }
        { on = [ "h" "m" ]; exec = "linemode mtime"; desc = "Set linemode to mtime"; }
        { on = [ "h" "n" ]; exec = "linemode none"; desc = "Set linemode to none"; }
        ...
        { on = [ "k" ]; exec = "find_arrow"; }
        { on = [ "K" ]; exec = "find_arrow --previous"; }
      ...
      input.keymap = [
        ...
        # Mode
        { on = [ "l" ]; exec = "insert"; desc = "Enter insert mode"; }
        { on = [ "a" ]; exec = "insert --append"; desc = "Enter append mode"; }
        { on = [ "L" ]; exec = [ "move -999" "insert" ]; desc = "Move to the BOL; and enter insert mode"; }
        ...
        { on = [ "j" ]; exec = "forward --end-of-word"; desc = "Move forward to the end of the current or next word"; }
