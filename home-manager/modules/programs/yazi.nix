  ...
  programs.yazi = {
    ...
    keymap = {
      manager.keymap = [
        ...
        # Navigation
        { on = [ "m" ]; run = [ "leave" "escape --visual --select" ]; desc = "Go back to parent directory"; }
        ...
        { on = [ "<A-n>" ]; run = "peek 5"; desc = "Peek down 5 units in the preview"; }
        { on = [ "<A-e>" ]; run = "peek -5"; desc = "Peek up 5 units in the preview"; }
        ...
        { on = [ "U" ]; run = "select_all --state=none"; desc = "Inverse selection of all files"; }
        ...
        # Linemode
        { on = [ "h" "s" ]; run = "linemode size"; desc = "Set linemode to size"; }
        { on = [ "h" "p" ]; run = "linemode permissions"; desc = "Set linemode to permissions"; }
        { on = [ "h" "m" ]; run = "linemode mtime"; desc = "Set linemode to mtime"; }
        { on = [ "h" "n" ]; run = "linemode none"; desc = "Set linemode to none"; }
      ...
      input.keymap = [
        ...
        { on = [ "m" ]; run = "move -1"; desc = "Move back a character"; }
